...
const Footer = () => {
    return (
        <Container customClass="md:py-[2em] bg-white flex flex-col gap-[1em] max-lg:p-[.5em]">
            <span className="flex max-lg:flex-col max-sm:flex-col max-sm:gap-[.8em] md:flex md:justify-between md:py-[5em] max-lg:gap-[.8em]">
                ...
                <span className="flex items-center gap-[.5em] z-10">
                    <span className="bg-[#F1F8FE] border flex gap-[.5em] px-[.5em] rounded-[8px] max-lg:w-[100%]">
                        ...
                        <input type="text" placeholder="Digite o seu email" className="border-none md:py-[.5em] md:px-[.2em] max-lg:py-[.5em] max-lg:px-[.2em] bg-transparent max-lg:w-full"/>
                    </span>
                    <span>
            ...
            <span className="flex justify-between md:py-[2em]">
                ...
                <span className="flex gap-[4em]">
                    <span className="text-[10pt] font-[300] md:flex md:flex-col cursor-pointer z-10 max-sm:flex max-lg:flex maxsm:flex-col max-lg:flex-col ">
                        <Link className="hover:text-[#1E90CE] cursor-pointer" href="about">Sobre nós</Link>
                        <Link className="hover:text-[#1E90CE] cursor-pointer" href="service">Nossos serviços</Link>
                    </span>
                </span>
            </span>
            <hr />
