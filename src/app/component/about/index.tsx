...
const About = () => {
    return (
        <Container customClass="md:py-[5em] flex flex-col md:gap-[2em] max-sm:gap-[2em] max-lg:gap-[2em] bg-[#1D87C5] text-white md:h-[100%] max-sm:p-[.5em] max-sm:py-[3em] max-lg:py-[3em]" id="about">
            <span className="flex flex-col gap-[1em]">
                <span className="w-[40%] max-sm:w-full max-lg:w-full max-sm:text-center">
                    <h1 className="text-[20pt] md:w-full max-sm:w-full max-lg:w-full font-[700]">Cross Over</h1>
                </span>
                <span className="md:w-full flex gap-[2em] flex-col text-[12pt] max-sm:text-center">
            ...
            <span className="flex md:justify-between flex-wrap max-sm:gap-[2em]">
