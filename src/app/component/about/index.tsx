    ...
    return (
        <Container customClass="md:py-[5em] flex flex-col md:gap-[2em] max-sm:gap-[2em] scroll-smooth max-lg:gap-[2em] bg-[#1D87C5] text-white md:h-[100%] max-sm:p-[.5em] max-sm:py-[3em] max-lg:py-[3em] max-xl:px-[1em]" id="about">
            <span className="flex flex-col gap-[1em]">
                <span className="w-[40%] max-sm:w-full max-lg:w-full max-sm:text-center max-xl:text-center max-xl:w-full">
                    <h1 className="text-[18pt] md:w-full max-sm:w-full max-lg:w-full font-[700] max-xl:w-full xl:w-[80vw] w-full">Cross Over Angola</h1>
                </span>
            ...
            <span className="flex md:justify-between flex-wrap max-xl:text-center max-sm:gap-[2em] max-xl:flex max-xl:flex-wrap max-xl:items-center max-xl:justify-center max-xl:flex-col">
