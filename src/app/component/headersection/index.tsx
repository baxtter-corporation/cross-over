        ...
        <Container customClass={`md:h-[100vh] relative max-sm:h-[60vh] max-lg:h-[60vh] max-sm:p-[.5em]`}>
            <span className="flex flex-col md:h-[100vh] max-sm:h-[60vh] max-lg:h-[60vh]">
                <span className="flex flex-col text-center justify-center items-center md:h-full max-sm:h-full max-lg:h-full">
                    <h1 className="md:text-[65px] font-[800] text-white py-4 px-6 rounded-lg max-lg:text-center max-sm:text-center max-sm:text-[15.5pt] max-lg:text-[15.5pt]">Inovação com Inteligência e Segurança</h1>
                    <span className="md:w-[820px] max-sm:text-justify max-lg:text-justify">
                        <p className="md:text-[14pt] font-[500] text-white max-sm:text-center max-lg:text-center">A CrossOver oferece soluções de segurança personalizadas, com foco em tecnologia e expertise, para que você possa ter mais tranquilidade.</p>
                    </span>
                </span>
            </span>
        </Container>
